...
TIPOS_ACTIVO = [
    ...
    ( 8, "GENERADOR", "GENERADOR",             "Electrico" ,      True,  True,  "FRM_GENE", 0.1),
    ...
    (15, "UPS",       "UPS",                   "Electrico" ,      True,  True,  "FRM_UPS",  0.05),
    (16, "SERVIDOR",  "SERVIDOR",              "TI",             True,  False, "FRM_SERV", 0.05),
    (17, "NAS",       "NAS",                   "TI",             True,  False, "FRM_NAS",  0.05),
    (18, "SUBESTA",   "SUBESTACIÓN",           "Electrico" ,      True,  True,  "FRM_SUBE", 0.1),
